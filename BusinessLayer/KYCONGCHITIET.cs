	...
	public class KYCONGCHITIET
	{
		...
		public void phatSinhKyCongChiTiet(int macty, int thang, int nam)
		{
			...
			foreach (var item in lstNV)
			{
				...
				kycongchitiet.NGAYCONG = QLNS_B_Functions.demSoNgayLamViecTrongThang(thang, nam);
				kycongchitiet.TONGNGAYCONG = QLNS_B_Functions.demSoNgayLamViecTrongThang(thang, nam);
